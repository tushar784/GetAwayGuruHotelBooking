...
function Login(){
    return (
        ...
        <div className=' h-dvh lg:flex lg:pt-0 pt-[2rem] '>
            ...
            <h1 className='text-black lg:text-2xl font-bold lg:mt-14 lg:ml-8 ml-[7rem] mt-4 text-xl lg:pt-0 pt-4' >Login in</h1>
           ...
           <h2 className='text-black text-sm font-semibold lg:mt-5 lg:ml-8 mt-4 ml-10'>Password</h2>
            ...
            <p className='flex'> 
                <p className="flex">
                    ...
                    <p className="lg:mt-6 lg:ml-0 text-slate-400 mt-[0.7rem] text-sm">Remember me</p>
                </p>
                <p className="lg:ml-20 lg:mb-8 lg:mt-6 text-slate-400 text-sm mt-[0.7rem] ml-6 lg:mr-10">Forgot Password?</p>
            </p>

            
                {/* Log in Button */}
           <button className="text-white font-bold lg:w-80 lg:h-10 lg:ml-8 lg:mb-4 lg:mt-4 w-60 mt-2 ml-10 h-8 rounded" style={{backgroundColor:"#90CCBA"}}>
                Log in
            </button>
