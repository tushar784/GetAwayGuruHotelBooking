...
//       <Slider {...settings}>
//         {[Switzerland, Hongkong, southkorea, greece, france, dubai, abudhabi].map((img, index) => (
//           <div key={index} className="px-2 overflow-hidden rounded-xl">
//             <button onClick={() => navigate(`/holidaypackages/location/${img.split('/').pop().split('.')[0].replace('Holiday', '')}`)}>
//               <img
//                 src={img}
//                 alt={img.split('/').pop().split('.')[0]}
//                 className="object-cover w-full h-[21rem] transition duration-300 transform hover:scale-110 rounded-xl"
//               />
//             </button>
//           </div>
//         ))}
