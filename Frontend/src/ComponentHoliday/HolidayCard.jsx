...
const HolidayCard = ({ holiday }) => {
  ...
  return (
    <div
      className={`transform transition-transform duration-300 hover:scale-105 bg-white w-[24rem] md:w-[22rem] md:ml-0 ml-[2rem] shadow font-poppins rounded-lg overflow-hidden mb-4 transition-all duration-300 ${
    ...
    >
      <div className="h-auto mt-2 ml-2 rounded-lg w-full mr-2">
        <img
          ...
          className="object-cover w-[22rem] md:w-[20rem] h-[12rem] md:h-[14rem] rounded m-2"
        />
      </div>
