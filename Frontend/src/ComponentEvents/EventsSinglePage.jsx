...
function EventsSinglePage() {
  ...
  return (
    <>
      <Navbar />
        {/* <Link to={`/eventcheckout/${eventName}?eventImage=${event.Main_Img}&eventVenue=${event.Show_venu}&eventDate=${event.Date}&eventPrice=${event.Price}`}> */}
        ...
        <div className="min-h-screen flex flex-col items-center ">
          ...
          <div className="border border-slate-400 h-[13rem] w-[60rem] rounded-lg p-8 mt-8">
            {/* <Link to={`/events/checkout/${eventName}`} > */}
            <div className="flex ">
              ...
              <Link
                to={`/events/checkout/${eventName}`}
              >
                <button className="bg-[#90CCBA] text-white font-bold py-2 px-8 rounded absolute right-0	mr-[10rem]">
                  Book Now
                </button>
              </Link>
            </div>
            ...
            {showLayout && (
              <div className="p-4 bg-gray-100 rounded">
                <img
                  ...
                  className="w-[30rem] h-[45rem] ml-[14rem] rounded"
                />
              </div>
            )}
          </div>
