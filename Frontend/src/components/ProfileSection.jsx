    ...
    <>
      ...
      <div className="flex flex-col md:flex-row h-auto md:h-[36.5rem] font-poppins ">
        <div className="w-full md:w-[15rem] bg-[#90CCBA] md:order-1 ">
          <h2 className="text-2xl font-semibold text-white font-poppins mt-[2rem] md:mt-[5rem] ml-4">
            Profile
          </h2>
          <p className="text-xl text-white font-poppins mt-[1rem] ml-4">
            Order history
          </p>
        ...
        <div className="w-full md:w-[66rem] bg-gray-100 md:order-2 ">
          <div className="flex flex-col md:flex-row w-full md:border md:border-gray-500 md:mt-[3rem] md:w-[63rem] md:h-[23rem] rounded p-4 ml-4 ">
              ...
              <div className="relative mb-4">
                ...
                <div className="absolute inset-0 flex items-center justify-center w-[7rem] mt-[9rem] ">
                  <label
                    ...
                    className="bg-[#90CCBA] text-xs text-white px-2 py-2 rounded cursor-pointer"
                  >
                    Change photo
                  </label>
                  <input
            ...
            <div className="w-full md:w-[30rem] md:mt-[1.5rem] mt-[4rem]">
              ...
              <button
                type="submit"
                className="bg-[#90CCBA] text-white md:px-4 md:py-2 md:p-0 px-2 py-2 rounded md:mt-[0.6rem] md:ml-0 ml-[5.6rem] md:text-[1rem] text-xs mobile-save-changes"
              >
                Save changes
              </button>
            </div>
            ...
            <div className="hidden md:block md:w-[17rem] ml-[10rem]">
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center mt-[19.5rem]">
                  <label
                    htmlFor="photo-upload"
                    className="bg-[#90CCBA] text-white px-4 py-2 rounded cursor-pointer"
                  >
                    Change photo
                  </label>
                  <input
