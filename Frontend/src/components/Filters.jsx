...
//   const handleFilterChange = (filter) => (e) => {
//     const isChecked = e.target.checked;
//     setFilters((prevFilters) => ({ ...prevFilters, [filter]: isChecked }));
//   };

//   const handlePriceSortChange = (e) => {
//     const selectedPriceSort = e.target.value;
//     setFilters((prevFilters) => ({ ...prevFilters, priceSort: selectedPriceSort }));
//   };

//   const handleStarRatingChange = (e) => {
//     const selectedStarRating = e.target.value;
//     setFilters((prevFilters) => ({ ...prevFilters, starRating: selectedStarRating }));
//   };
