...
const HotelCard = ({ hotel }) => {
  ...
  return (
    <div
      className={`bg-white w-full md:w-[22rem] md:ml-[rem] shadow font-poppins rounded-lg overflow-hidden mb-4 transition-all duration-300 ${
...
// final// import React, { useState } from "react";
