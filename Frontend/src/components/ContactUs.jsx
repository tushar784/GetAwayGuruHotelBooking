    ...
    <>
      ...
      <div className="flex justify-center font-poppins items-center h-screen">
        <div className="flex flex-col md:flex-row rounded-lg pl-8 pr-8 pb-8">
          <form action="https://formspree.io/f/moqgzvbl" method="POST">
            {/* Left Side */}
            <div className="md:w-[36rem] md:mt-0 mt-[18rem] md:pr-8 md:ml-[9rem]">
              ...
              <button type="submit" className="bg-[#90CCBA] text-white px-4 py-2 rounded-md hover:bg-[#46c79f]">Send</button>
            </div>
          </form>
          ...
          <div className="md:w-[23rem] md:h-[25rem] md:ml-[3rem] md:pl-8 md:mt-0 mt-8 bg-[#90CCBA] text-white p-6 rounded">
            ...
            <div className="mb-4 flex items-center">
              <MdPhoneInTalk className="text-white mr-2" aria-hidden="true" /> <span>8975641235</span>
            </div>
            <div className="mb-4 flex items-center">
              <IoMail className="text-white mr-2" aria-hidden="true" /> <span>demo@gmail.com</span>
            </div>
            <div className="flex items-center">
              <ImLocation2 className="text-white mr-2" aria-hidden="true" /> <span>123 Juhu Beach Road, Juhu, Mumbai, Maharashtra, India</span>
            </div>
          </div>
        </div>
      </div>
